...
class ParserContext
{
	...
	void LogErrorSem (RetType in, std::string msg, TokenInfo const& tok);

	void LogErrorUniqueProcedure (RetType in, TokenInfo const& t);
	void LogErrorIdentifierScope (RetType in, TokenInfo const& t);
	void LogErrorUniqueIdentifier (RetType in, TokenInfo const& t);
